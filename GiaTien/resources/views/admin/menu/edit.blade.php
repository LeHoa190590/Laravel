...
<form action="" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="text" name="name" value={{ $menu->name }} class="form-control"  placeholder="Nhập tên">
    </div>
    ...
    <div class="form-group">
        ...
        <div class="custom-control custom-radio">
            <input class="custom-control-input" type="radio" value="0" id="deactive" name="active" {{$menu->active == 0 ? 'checked=""':''}}>
